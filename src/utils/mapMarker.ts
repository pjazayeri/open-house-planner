 ...
 * "1" could both render on the map. Now every marker shows its global
 * tour stop (`visitOrder`) so numbers are unique; priority is conveyed
 * by `isPriority` (color + ★ badge in the icon).
 */
