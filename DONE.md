...
- **Design & Architecture page (`/#design`) + `docs/DESIGN.md`** *(shipped 2026-05-24)* — In-app high-level design overview (architecture layers, data-flow, decision cards) linking to the full `docs/DESIGN.md`. Admin-only (same gate as the dashboard). *Verify:* as the owner, open `/#design`, confirm it renders and the doc link works.
